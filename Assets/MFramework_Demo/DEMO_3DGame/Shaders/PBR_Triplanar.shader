Shader "MineselfShader/PBR/Triplanar"
{
    Properties
    {
        ...
        _CubemapInt("CubemapIntensity", Range(0, 3)) = 1
        [Space(5)]
    ...
    fixed4 frag (v2f i) : SV_Target
    {
        ...
        float3 baseRGB = LightingPBR_BASE
            (_BaseColor, _LightColor0, lDir, nDir, vDir,
                _BaseColorMap, _MetallicMap, _RoughnessMap, _AOMap, _Cubemap, atten, uv,
    ...
    fixed4 fragAdd (v2f i) : SV_Target
    {
        ...
        float3 baseRGB = LightingPBR_ADD
            (_BaseColor, _LightColor0, lDir, nDir, vDir,
                _BaseColorMap, _MetallicMap, _RoughnessMap, atten, uv,
                _Metallic, _Roughness, _LightInt);
