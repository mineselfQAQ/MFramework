...
{
    public class MHotUpdateManager
    {
        ...
        public MHotUpdateManager(MCoroutineManager coroutineManager, ABRuntimeState runtimeState)
        {
        ...
        private void DownloadABPack()
        {
            ...
            for (int i = 0; i < downloaderCount; i++)
            {
                ...
                ABDownloader downloader = new ABDownloader(this);
        ...
        internal void Shutdown()
        {
            OnUpdateEnd = null;
            OnCheckEnd = null;
            downloadTotalSize = 0f;
            curDownloadSize = 0f;
            localInfoDic.Clear();
            needUpdateInfoQueue.Clear();
