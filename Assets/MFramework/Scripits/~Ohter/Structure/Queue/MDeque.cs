...
{
    public class MDeque : IEnumerable
    {
        ...
        public MDeque() : this(32, 2.0f) { }
        public MDeque(int capacity) : this(capacity, 2.0f) { }
        public MDeque(int capacity, float growFactor)
        {
            //容量不可能小于0
            if (capacity < 0)
            {
        ...
        public object PeekLast()
        {
            ...
            int index = (_tail - 1) % _array.Length;
            return _array[index];
        }
...
public static class MDequeExtension
{
